// chat_sec.js - NaClCON override of the stock Synchronet chat section
//
// Identical to the stock exec/chat_sec.js except the 'T' (Talk to Guru)
// option loads pelican.js instead of calling bbs.page_guru().
