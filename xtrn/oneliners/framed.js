...
var initFrames = function() {
	...
	inputAliasFrame.putmsg("\1h\1m" + user.alias + "\1n\1w@\1h\1y" + system.qwk_id.toLowerCase() + "\1h\1k: ");
	promptFrame.putmsg("\1h\1wAdd a oneliner to the wall? [\1h\1yY\1n\1w/\1h\1wN\1h\1k]");
	frame.drawBorder([LIGHTRED, LIGHTRED, LIGHTRED, LIGHTRED]);
	var header = format(
		"\1h\1r%s\1h\1c nacl\1h\1mcon\1h\1wbbs\1h\1y oneliners \1h\1r%s",
		ascii(180), ascii(195)
	);
